...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="hidden-xs col-sm-12 col-md-12">
            <p align="center">
                <!-- <button type="button" style="margin-left:auto;margin-right:auto;display:block;margin-top:22%;margin-bottom:0%"> &nbsp;</button> -->

                <a href="{{ url('admin/login') }}" class="btn btn-primary" style="margin-left:auto;margin-right:auto;margin-top:22%;margin-bottom:0%"><i class="voyager-person"></i> &nbsp;Sign In >></a>
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <div class="copy animated fadeIn">
                            ...
                            <p>2020 &copy; DPMPTSP Prov. Jateng </p>
                        </div>
