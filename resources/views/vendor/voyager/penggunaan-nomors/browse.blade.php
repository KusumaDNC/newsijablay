...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-settings"></i> Penggambilan Nomor <!-- {{ __('voyager::generic.settings') }} -->
    </h1>
@stop
...
@section('content')
    ...
    <div class="page-content settings container-fluid">
        ...
        <form action="{{route('add.nd')}}" method="POST" enctype="multipart/form-data">
            {{ method_field("PUT") }}
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="form-group"><label>Tanggal</label>
                        <div class="input-group date">
                            ...
                            <input type="hidden" name="time" id="time" class="form-control" value="{{date('H:i:s')}}">
                        </div>
                    </div>
                </div>
            </div>
